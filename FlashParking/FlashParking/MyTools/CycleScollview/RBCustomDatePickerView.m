...
//    NSInteger dayInt = [dateString substringWithRange:NSMakeRange(6, 2)].integerValue;
    ...
    //修改格式
    resultTimeStr=[NSString stringWithFormat:@"%@:%@:%@",[dateString substringWithRange:NSMakeRange(8, 2)],[dateString substringWithRange:NSMakeRange(10, 2)],[dateString substringWithRange:NSMakeRange(12, 2)]];
  ...
  //  nowPickerShowTimeLabel.text = [NSString stringWithFormat:@"%@年%d月%d日 %@ %@:%@:%@",[dateString substringWithRange:NSMakeRange(0, 4)],monthInt,dayInt,weekString,[dateString substringWithRange:NSMakeRange(8, 2)],[dateString substringWithRange:NSMakeRange(10, 2)],[dateString substringWithRange:NSMakeRange(12, 2)]];
    ...
    timeBroadcastView = [[UIView alloc] initWithFrame:CGRectMake(60, 40, 180, 190.0)];
...
{
    hourScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(20, 0, 39.0, 190.0)];
...
{
    minuteScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(70, 0, 37.0, 190.0)];
...
{
    secondScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(120, 0, 43.0, 190.0)];
